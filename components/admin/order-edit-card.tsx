    ...
    <div className="rounded-md border p-4 bg-muted flex flex-col md:flex-row gap-4">
      ...
      <div className="flex flex-col items-end gap-4 min-w-[180px]">
        ...
        <div className="flex gap-2 bottom-4">
          {!confirmingCancel ? (
            <>
              <Button variant="destructive" onClick={() => setConfirmingCancel(true)}>Cancel Booking</Button>
            ...
            <>
              ...
              }}>{saving ? 'Cancelling...' : 'Confirm Cancel'}</Button>
              <Button variant="ghost" onClick={() => setConfirmingCancel(false)}>Back</Button>
            </>
          )}
        </div>
